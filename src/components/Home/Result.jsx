    ...
    <div className=' mb-36  max-w-[800px] mx-auto'>
      ...
      >
        ...
        <div className='mt-10 flex w-full items-center justify-center ' >
          <NavLink
            to="/results"
            className=' text-center text-white bg-[#280B0C] capitalize rounded-md py-2 px-4 font-semibold cursor-pointer hover:bg-[#73052F] transition-all ease-in-out '>Other Results</NavLink>
        </div>
      </motion.div>

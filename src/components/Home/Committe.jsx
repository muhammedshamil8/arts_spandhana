        ...
        <section className='flex gap-10  mx-auto items-center justify-center  max-w-full main-committe-parent'>
          ...
          >
            <div className='flex flex-col items-center justify-center'>
              ...
              <div className='relative main-committee overflow-hidden'>
                <img src={Sheela} alt='main1' className='w-full h-full object-cover' />
              ...
              <div className='flex items-center justify-start  w-full'>
                <h3 className='font-semibold text-2xl leading-6 text-gray-900 mt-2 main-committee-name'>Sheela</h3>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className='flex flex-col items-center justify-center'>
              ...
              <div className='relative main-committee overflow-hidden'>
                <img src={Shahina} alt='main1' className='w-full h-full object-cover' />
                <div className='absolute background-custom-color h-20 w-10 -top-8 -left-5 rotate-45'></div>
                <div className='absolute background-custom-color h-[70px] w-10 -bottom-8 -right-5 rotate-45'></div>
              </div>
              <div className='flex items-center justify-start  w-full'>
                <h3 className='font-semibold text-2xl leading-6 text-gray-900 mt-2 main-committee-name'>Shahina</h3>
              </div>
            </div>
          </motion.div>
          <motion.div
          ...
          >
            <div className='flex flex-col items-center justify-center '>
              ...
              <div className='relative main-committee overflow-hidden'>
                <img src={Safa} alt='main1' className='w-full h-full object-cover' />
                <div className='absolute background-custom-color h-20 w-10 -top-8 -left-5 rotate-45'></div>
                <div className='absolute background-custom-color h-[70px] w-10 -bottom-8 -right-5 rotate-45'></div>
              </div>
              <div className='flex items-center justify-start  w-full'>
                <h3 className='font-semibold text-2xl leading-6 text-gray-900 mt-2 main-committee-name'>Safa KK</h3>
              </div>
            </div>
          </motion.div>
        </section>

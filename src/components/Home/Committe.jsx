...
import Mohammed from "../../assets/arts/Mohammed.png";
...
function Committe() {
  return (
    <div className="w-full mx-auto " id="committee">
      <h1 className="font-bold text-3xl text-center mb-10 text-black">
        Committee
      </h1>
      <main className="flex flex-col gap-16 p-4 mx-auto items-center ">
          ...
          >
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex items-center justify-start  w-full">
                <h3 className="font-semibold text-2xl leading-6 text-gray-900 mt-2 main-committee-name">
                  Mohammed
                </h3>
              </div>
            </div>
        ...
        <section className="flex flex-col gap-2 items-center ">
          <div className="text-center flex items-center gap-6  relative  mb-3 overflow-hidden w-full">
            ...
            <span className="text-3xl font-bold  uppercase text-[#73052F] text-nowrap onstage-committee-heading">
              JOIN CONVENER
            </span>
            <hr className="border-[2px] border-[#73052F] w-1/2 mx-auto" />
          ...
          <div className="flex gap-4 w-full mx-auto onstage-committee-parent">
            ...
            >
              <div className="flex flex-col items-center justify-center ">
                ...
                <div className="flex items-center justify-start  w-full">
                  <h3 className="font-semibold text-gray-800 text-xl mt-2 capitalize text-wrap onstage-committee-name">
                    Safa KK
                  </h3>
                </div>
              </div>
